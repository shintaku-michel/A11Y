...
var AlcCheckbox = function() {
  ...
  t.prototype.render = function() {
    return h(Host, { key: "a179d87b40573e1ad81802377317efef827c849a" }, h("slot", { key: "1574ef832bb947b7e90095c47ca372d6a4a7dc4c" }), h("div", { key: "77f58ecc51076beeb1c468cdaa1f845961d8c866", class: "alc-checkbox__label" }, h("div", { key: "dea6b75f230ec6989be8bdbb894f83c15f1106e7" }, this.label ? h("label", Object.assign({ htmlFor: this.inputId }, testAttributes()), this.label) : h("slot", { name: "label" })), this.errorMsg ? h("small", Object.assign({ class: "alc-checkbox__text alc-checkbox__text--error", id: this.errorId }, testAttributes()), this.errorMsg) : null, this.hint ? h("small", Object.assign({ class: "alc-checkbox__text", id: this.hintId }, testAttributes()), this.hint) : null));
  };
