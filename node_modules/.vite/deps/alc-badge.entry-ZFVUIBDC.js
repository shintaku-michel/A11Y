...
var AlcBadge = function() {
  ...
  a.prototype.render = function() {
    ...
    return h(Host, { class: "alc-badge-wrapper" }, h("slot", null), (this.dot || this.label) && h("span", { class: "alc-badge alc-badge--".concat(this.color, " \n              ").concat(this.dot ? "alc-badge--dot" : "", " \n              ").concat(this.count ? "alc-badge--count" : "", "\n              ").concat(this.outlined ? "alc-badge--outlined" : "", " alc-badge--").concat(this.position, "\n              ").concat(this.pulsate ? "alc-badge--pulsate" : "") }, !this.dot && this.label));
  };
  return a;
}();
AlcBadge.style = alcBadgeCss;
export {
  AlcBadge as alc_badge
};
