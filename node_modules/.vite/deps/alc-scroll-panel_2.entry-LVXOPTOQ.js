...
var AlcScrollPanel = function() {
  ...
  t.prototype.handleScrollToElement = function(t2) {
    if (!!t2) {
      t2.scrollIntoView({ inline: "center", block: "nearest" });
    }
  };
  ...
  t.prototype.startScrolling = function(t2, o) {
    var l = this;
    if (this.scrolling) return;
    this.scrolling = window.setInterval(function() {
      if (t2.disabled) {
        l.stopScrolling();
        return;
      }
  ...
  t.prototype.startScrollingRight = function(t2) {
    var o = t2.currentTarget;
    if (o instanceof HTMLButtonElement) {
      this.startScrolling(o, this.scrollRight);
    }
  };
  t.prototype.startScrollingLeft = function(t2) {
    var o = t2.currentTarget;
    if (o instanceof HTMLButtonElement) {
      this.startScrolling(o, this.scrollLeft);
    }
  };
  ...
  t.prototype.setCanScroll = function() {
  ...
  t.prototype.componentDidRender = function() {
    var t2 = this;
    var o;
    (o = this.mo) === null || o === void 0 ? void 0 : o.disconnect();
  ...
  t.prototype.render = function() {
    var t2 = this;
    return h(Host, { key: "3c5dee05949d2b073dcb87abd7c4df0826377f4c" }, h("div", { key: "8cb56b2dfa1b2b82f8b3eb7dd52018410e1a9554", class: "alc-scroll-panel" }, this.hasScroll ? h("div", { key: "left-button" }, h("button", { onClick: this.scrollLeft.bind(this), onMouseDown: this.startScrollingLeft.bind(this), onMouseUp: this.stopScrolling.bind(this), onTouchStart: this.startScrollingLeft.bind(this), onTouchEnd: this.stopScrolling.bind(this), onTouchCancel: this.stopScrolling.bind(this), class: "alc-scroll-panel__button", disabled: !this.canScrollLeft, "aria-label": "Ir para esquerda", tabindex: this.hasFocus ? "0" : "-1" }, h("alc-icon", { name: "chevron-left", label: "" }))) : null, h("div", { class: { "alc-scroll-panel__wrapper-content": true, "alc-scroll-panel__has-scroll-left": this.canScrollLeft, "alc-scroll-panel__has-scroll-right": this.canScrollRight }, key: "content" }, h("div", { key: "93e54d7ba7f47158fc3fcdfd357a742ed83568cc", class: "alc-scroll-panel__content", ref: function(o) {
      return t2.content = o;
    }, onScroll: function() {
      return t2.scrollThrottle();
    } }, h("slot", { key: "49672486ccf36230946da3949ee80fc61f4098c4" }))), this.hasScroll ? h("div", { key: "right-button" }, h("button", { onClick: this.scrollRight.bind(this), onMouseDown: this.startScrollingRight.bind(this), onMouseUp: this.stopScrolling.bind(this), onTouchStart: this.startScrollingRight.bind(this), onTouchEnd: this.stopScrolling.bind(this), onTouchCancel: this.stopScrolling.bind(this), class: "alc-scroll-panel__button", disabled: !this.canScrollRight, "aria-label": "Ir para direita", tabindex: this.hasFocus ? "0" : "-1" }, h("alc-icon", { name: "chevron-right", label: "" }))) : null));
  };
  Object.defineProperty(t.prototype, "el", { get: function() {
    return getElement(this);
  }, enumerable: false, configurable: true });
  Object.defineProperty(t, "watchers", { get: function() {
    return { scrollToElement: ["handleScrollToElement"] };
  }, enumerable: false, configurable: true });
  return t;
}();
AlcScrollPanel.style = { base: alcScrollPanelBaseCss, theme: themeAlcScrollPanelCss };
var alcTabButtonBaseCss = "alc-tab-button{display:inline-block}.alc-tabs__button.active{-webkit-text-decoration-line:underline;text-decoration-line:underline}";
var themeAlcTabButtonCss = '[data-alc-theme="dark"] .alc-tabs__button{--text-color:#52daf2;--bg-color-button:var(--alc-color-neutral-70)}[data-alc-theme="dark"] .alc-tabs__button:hover{--bg-color-button:#3d4551}[data-alc-theme="dark"] .alc-tabs__button.active{--text-color:var(--alc-color-text-primary);--bg-color-button:var(--bg-color)}[data-alc-theme="light"] .alc-tabs__button{--text-color:var(--alc-color-link-text);--bg-color-button:#dfe1e2}[data-alc-theme="light"] .alc-tabs__button:hover{--bg-color-button:#c6cace}[data-alc-theme="light"] .alc-tabs__button.active{--text-color:var(--alc-color-text-primary);--bg-color-button:var(--bg-color)}alc-tab-button{display:inline-block}.alc-tabs__button{z-index:10;border-color:var(--border-color);background-color:var(--bg-color-button);padding:0.5rem;padding-top:0.75rem;color:var(--text-color);border-right-width:var(--border-width);border-bottom-width:var(--border-width)}.alc-tabs__button.active{cursor:default;padding-top:0.5rem;-webkit-text-decoration-line:none;text-decoration-line:none;border-top-width:4px;border-bottom-color:transparent}alc-tab-button:first-child{border-color:var(--border-color);border-left-width:var(--border-width)}.alc-tabs__button:focus-visible,.alc-tabs__button.active:focus-visible{outline-style:solid;outline-width:2px;outline-offset:-8px;outline-color:var(--outline-color)}';
var AlcTabButton = function() {
  function t(t2) {
    registerInstance(this, t2);
  ...
  t.prototype.selectedChanged = function(t2, o) {
    if (t2 !== o) {
      if (t2) {
  ...
  t.prototype.selectTab = function(t2) {
    if (this.tab !== void 0) {
      this.alcClick.emit({ tab: this.tab });
      t2.preventDefault();
    }
  };
  t.prototype.keyDownHandler = function(t2) {
    var o = false;
    switch (t2.key) {
      case "ArrowRight":
        this.alcNext.emit();
  ...
  t.prototype.render = function() {
    var t2 = this;
    var o;
    (o = this.tab) !== null && o !== void 0 ? o : logger.report("tab", this.el.tagName.toLowerCase(), this.el);
    var l = function() {
      var o2;
      if (t2.el.id) {
        o2 = t2.el.id;
      } else {
        o2 = "alc-button_".concat(t2.el.tab);
      }
      return o2;
    };
    return h(Host, null, h("button", { onClick: this.selectTab.bind(this), onKeyDown: this.keyDownHandler.bind(this), role: "tab", "aria-selected": this.selected ? "true" : "false", tabindex: "-1", id: l(), class: { "alc-tabs__button": true, active: this.selected }, ref: function(o2) {
      return t2.button = o2;
    } }, h("slot", null)));
  };
  Object.defineProperty(t.prototype, "el", { get: function() {
  ...
  Object.defineProperty(t, "watchers", { get: function() {
    return { selected: ["selectedChanged"] };
  }, enumerable: false, configurable: true });
  return t;
}();
AlcTabButton.style = { base: alcTabButtonBaseCss, theme: themeAlcTabButtonCss };
export {
  AlcScrollPanel as alc_scroll_panel,
  AlcTabButton as alc_tab_button
};
//# sourceMappingURL=alc-scroll-panel_2.entry-LVXOPTOQ.js.map
