...
var AlcUserMenu = function() {
  function e(e2) {
    ...
    this.handleLogout = function(e3) {
      var r = a.alcLogout.emit().defaultPrevented;
      if (r) {
        e3.preventDefault();
      }
    };
  ...
  e.prototype.renderDesktop = function() {
    var e2 = this;
    return h("div", { class: { "alc-user-menu--desktop": true, hidden: this.variation === "mobile" } }, h("div", { class: "alc-user-menu__info--external" }, h("div", null, h("div", { class: "alc-user-menu__primary" }, h("span", { class: "alc-user-menu__name" }, this.name), this.registrationNumber && h("span", { class: "alc-user-menu__reg" }, "(", this.registrationNumber, ")")), h("div", { class: "alc-user-menu__secondary", ref: function(a) {
      return e2.desktopSlotContainer = a;
    } }))), h("alc-dropdown", { class: "alc-user-menu__dropdown" }, h("button", { slot: "trigger", class: "alc-user-menu__trigger", "aria-label": "Abrir menu do usuário" }, this.imgSrc ? h("img", { class: "alc-user-menu__image", src: this.imgSrc, alt: this.name }) : h("alc-icon", { class: "alc-user-menu__image alc-user-menu__icon", name: "person-fill", label: this.name }), h("alc-icon", { icon: "chevron-down", label: "" })), h("div", { class: "alc-user-menu__info--internal" }), h("div", { ref: function(a) {
      return e2.desktopMenuContainer = a;
    } })));
  };
  e.prototype.renderMobile = function() {
    var e2 = this;
    return h("div", { class: { "alc-user-menu--mobile": true, hidden: this.variation === "desktop" } }, h("div", { class: "alc-user-menu--mobile__header" }, this.imgSrc ? h("img", { class: "alc-user-menu__image", src: this.imgSrc, alt: this.name }) : h("alc-icon", { class: "alc-user-menu__image alc-user-menu__icon", name: "person-fill", label: this.name }), h("div", { class: "alc-user-menu--mobile__info" }, h("div", { class: "alc-user-menu__name" }, this.name, this.registrationNumber && h("span", { class: "alc-user-menu--mobile__reg" }, "(", this.registrationNumber, ")")), h("div", { class: "alc-user-menu__secondary", ref: function(a) {
      return e2.mobileSlotContainer = a;
    } }))), h("alc-expander", { label: "Menu do usuário", open: false, "hide-label": "true" }, h("div", null, h("div", { ref: function(a) {
      return e2.mobileMenuContainer = a;
    } }))));
  };
  e.prototype.render = function() {
    var e2 = this;
    var a;
    (a = this.logoutUrl) !== null && a !== void 0 ? a : logger.report("logoutUrl", this.host.tagName.toLowerCase(), this.host);
    return h(Host, { key: "1df7026fa5897691438a13aebfb38ad075f942f0" }, h("alc-menu", { key: "113f70bfb848564bf76a688356a458042e5e4cc0", ref: function(a2) {
      return e2.menu = a2;
    } }, h("slot", { key: "13bdfda9dbb3a473380af99c6f47dde82f81f065", name: "actions" }), h("alc-menu-item-theme", { key: "5dcb6428c37d40843c29d77c5d3c164516646c0a" }), h("alc-menu-link", { key: "dc29f0f8eec9b925e2f99330113f6b5a26d843b6" }, h("a", { key: "93b72f1a292ed1a45250aa7b515b40f2480c05a2", href: this.logoutUrl, onClick: this.handleLogout }, h("alc-icon", { key: "50c85a0422c3d2d87b340309917f12c0dedf4a37", name: "box-arrow-right", label: "", class: "alc-user-menu__logout-icon" }), "Sair"))), h("div", { key: "9b8f2386263e18f980625e276ba8eb72a152e28d", ref: function(a2) {
      return e2.defaultSlot = a2;
    } }, h("slot", { key: "99a076179acea8e92cc4bf7f825593fc2dede355" })), [this.renderMobile(), this.renderDesktop()]);
  };
  Object.defineProperty(e.prototype, "host", { get: function() {
