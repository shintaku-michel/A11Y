...
var AlcHeader = function() {
  ...
  e.prototype.handleScroll = function() {
    ...
    var e2 = window.pageYOffset || document.documentElement.scrollTop;
    var a = this.scrollDirection;
    if (e2 > this.scrollTop && a !== "down" && e2 > this.el.clientHeight / 2) {
      this.wrapper.classList.add("alc-header--scroll-down");
      a = "down";
    }
    if (e2 < this.scrollTop && a !== "up") {
      a = "up";
      this.wrapper.classList.remove("alc-header--scroll-down");
    }
    this.scrollTop = e2 <= 0 ? 0 : e2;
    this.scrollDirection = a;
  };
  e.prototype.handleNavContent = function(e2) {
    var a, t;
    var r = e2.detail, i = r.navEl, s = r.isMobile;
    var n = (a = this.drawer) !== null && a !== void 0 ? a : this.el.querySelector("alc-drawer");
    var l = (t = this.navPanel) !== null && t !== void 0 ? t : document.querySelector("alc-nav-panel");
    if (!n || !l) {
      return;
    }
    var o = n.querySelector(".alc-drawer__header + div") || n;
    var c = l.querySelector(".alc-nav-panel__content");
    if (!o || !c) {
      return;
    }
    if (s) {
      ...
      l.classList.add("alc-nav-panel--hidden");
    } else {
      if (o.contains(i)) {
        o.removeChild(i);
      }
      ...
      l.classList.remove("alc-nav-panel--hidden");
    }
  };
  ...
  e.prototype.handleAlcHome = function(e2) {
    e2.stopPropagation();
    var a = this.alcHome.emit();
  ...
  e.prototype.componentDidRender = function() {
    var e2 = this;
    var a = { link: "menu-link", "menu-link": "menu-link", button: "menu-item", "menu-item": "menu-item", null: "menu-item" };
    var t = { link: "link", "menu-link": "link", button: "button", "menu-item": "button", null: "button" };
    if (!this.supportItems.length) {
      var r = this.slotSupport.assignedElements();
      if (r.length > 0) {
        Array.from(r[0].children).forEach(function(a2) {
          e2.supportItems.push(a2);
        });
      }
    }
    if (!this.userMenu) {
    ...
    if (this.isSupportDropdown || this.isDrawer) {
      ...
      var i = this.userMenu.querySelector("alc-menu");
      if (this.supportItems.length > 0) {
        var s = document.createElement("div");
        s.role = "group";
        var n = document.createElement("div");
        n.className = "alc-header__menu-separator";
        n.role = "separator";
        n.innerText = "Menu de apoio";
        n.id = getUniqueId();
        s.appendChild(n);
        s.setAttribute("aria-labelledby", n.id);
        Array.from(this.supportItems).forEach(function(e3) {
          e3.variant = a[e3.variant];
          s.appendChild(e3);
        });
        logger.debug("header insertElement menu", this.supportItems, s);
        this.menuSupport.appendChild(s);
        i.insertAdjacentElement("beforeend", this.menuSupport);
      }
      setTimeout(function() {
      ...
      Array.from(this.supportItems).forEach(function(a2) {
        a2.variant = t[a2.variant];
        e2.support.appendChild(a2);
      });
    }
    if (this.isDrawer) {
  ...
  e.prototype.componentDidLoad = function() {
    ...
    setTimeout(function() {
      e2.calcRequiredWidth();
      e2.observer.observe(e2.el);
    }, 100);
  };
  e.prototype.render = function() {
    var e2 = this;
    var a, t;
    (a = this.name) !== null && a !== void 0 ? a : logger.report("name", this.el.tagName.toLowerCase(), this.el);
    (t = this.homeUrl) !== null && t !== void 0 ? t : logger.report("homeUrl", this.el.tagName.toLowerCase(), this.el);
    return h(Host, { key: "50843cc351b03605b026104a99b765dbd2ec1af5" }, h("div", { key: "acd386bda99c06051a3ecc8c39c7a311bba075aa", class: "alc-header", ref: function(a2) {
      return e2.wrapper = a2;
    } }, h("header", { key: "8dc133f406d7e46b7ed5c6a43370c9e6195eb24b", class: "alc-header__header" }, h("slot", { key: "33803ee86ade7cd59fdf3522e6a52be4f143ecd3" }), h("slot", { key: "a12d423b6d9a76409c8b6407be44c9e38b383823", name: "support", ref: function(a2) {
      return e2.slotSupport = a2;
    } }), h("div", { key: "8f5a09861a39c6554cf9546d0ff148834802a222", class: "alc-header__container" }, h("div", { key: "8ab01c8f29de13803764c09f6acfcec29fb54a02", class: "alc-header__id" }, h("alc-header-id", { key: "ae05e593ef6c66b4014b4a4de6472fa13807ed4d", name: this.name, description: this.description, homeUrl: this.homeUrl, "onAlc-home": this.handleAlcHome.bind(this) })), h("div", { key: "363e93508d9792a435031c168a1e6447977c1c66", class: "alc-header__panel" }, h("div", { key: "ce81a3325dd43039f552b4a4a672046525bbc06e", class: "alc-header__support-wrapper", ref: function(a2) {
      return e2.supportWrapper = a2;
    } }, h("div", { key: "06ac79d9b6afaf7019e1aec483b6c439cc7f00e7", class: "alc-header__support", ref: function(a2) {
      return e2.support = a2;
    } })), h("div", { key: "97879eb8fa630920969b381d3d6c70603efe118e", class: "alc-header__fixed" }, h("slot", { key: "18e753581b7bc1550c147c86d82afc1ef62d52a7", name: "fixed", ref: function(a2) {
      return e2.slotFixed = a2;
    } })), h("div", { key: "bc5a9abe1c62324b5b31f7da8e6ef1f400232e6f", class: "alc-header__drawer-nav" }, h("button", { key: "45ccd23d19b2596a114d5a06e1542c4f2c894ab7", class: "alc-header-button", onClick: function() {
      return e2.drawer.show();
    }, "data-alc-header-drawer-button": true }, h("alc-icon", { key: "034076d0807c83526105def7a2a5c0cb65edd68e", icon: "list", label: "Abrir navegação", class: "alc-header-button__icon" })), h("alc-drawer", { key: "30239f69ac0224bea50bf15e9a867c8caaf70940", ref: function(a2) {
      return e2.drawer = a2;
    } })), h("div", { key: "183ef67e4d5b88f4c9b0a627ea37d718e498e38a", class: { "alc-header__user": true, "alc-header__user--separator": this.needSeparator } }, h("slot", { key: "e43720d6466616b229f77420745637b68a63c24d", name: "user", ref: function(a2) {
      return e2.slotUser = a2;
    } })))))));
  };
  e.prototype.calcRequiredWidth = function() {
  ...
  e.prototype.checkLayout = function() {
    this.supportWrapper.style.overflowY = "hidden";
    this.supportWrapper.style.overflowX = "clip";
  ...
  e.prototype.fixedElementsVisible = function() {
    var e2 = this.slotFixed.assignedElements()[0];
    if (e2 instanceof HTMLElement) {
      return e2.offsetWidth > 0;
    }
    return false;
  };
