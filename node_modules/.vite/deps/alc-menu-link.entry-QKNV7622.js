...
var AlcMenuLink = function() {
  ...
  e.prototype.handleDisabledChange = function(e2) {
    this.updateLinkState(e2);
  };
  ...
  e.prototype.updateLinkState = function(e2) {
    var l = this.hostElement.querySelector("a");
    if (l) {
      if (e2) {
        this.originalHref = l.getAttribute("href");
        l.setAttribute("aria-disabled", "true");
        l.classList.add("alc-menu-link--disabled");
        l.setAttribute("tabindex", "-1");
        l.removeAttribute("href");
        l.setAttribute("role", "menuitem");
      } else {
        if (this.originalHref) {
          l.setAttribute("href", this.originalHref);
        }
        l.removeAttribute("aria-disabled");
        l.classList.remove("alc-menu-link--disabled");
  ...
  e.prototype.handleKeyDown = function(e2) {
    if (!this.disabled && e2.key === " ") {
      e2.preventDefault();
      var l = this.hostElement.querySelector("a");
      if (l) {
        this.spaceKeyEvent = e2;
        l.click();
      }
    }
  };
  e.prototype.handleClick = function(e2) {
    var l;
    var a = (l = this.spaceKeyEvent) !== null && l !== void 0 ? l : e2;
    this.spaceKeyEvent = null;
    if (this.disabled) {
      e2.preventDefault();
    } else {
      this.triggerEvent({ originalEvent: a });
    }
  };
  ...
  Object.defineProperty(e, "watchers", { get: function() {
    return { disabled: ["handleDisabledChange"] };
  }, enumerable: false, configurable: true });
  return e;
}();
AlcMenuLink.style = alcMenuLinkCss;
export {
  AlcMenuLink as alc_menu_link
};
