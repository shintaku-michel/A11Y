...
// node_modules/alcance/dist/esm-es5/alc-input-file.entry.js
var __awaiter = function(t, e, r, o) {
  function i(t2) {
  ...
  return new (r || (r = Promise))(function(r2, a) {
    ...
    function c(t2) {
      t2.done ? r2(t2.value) : i(t2.value).then(n, l);
    }
...
var __generator = function(t, e) {
  ...
  function c(l2) {
    ...
    while (n && (n = 0, l2[0] && (r = 0)), r) try {
      if (o = 1, i && (a = l2[0] & 2 ? i["return"] : l2[0] ? i["throw"] || ((a = i["return"]) && a.call(i), 0) : i.next) && !(a = a.call(i, l2[1])).done) return a;
      if (i = 0, a) l2 = [l2[0] & 2, a.value];
      switch (l2[0]) {
        case 0:
        case 1:
          a = l2;
        ...
        case 7:
          ...
          continue;
        default:
          if (!(a = r.trys, a = a.length > 0 && a[a.length - 1]) && (l2[0] === 6 || l2[0] === 2)) {
            r = 0;
            continue;
          }
...
var AlcInputFile = function() {
  function t(t2) {
    ...
    this.disabled = false;
    this.required = false;
    this.buttonType = void 0;
    this.mode = "button";
    this.files = [];
    this.maxInputTextLength = 50;
    this.renderFiles = function() {
      return e.files.map(function(t3) {
        return h("div", Object.assign({ class: "alc-input-file__file" }, testAttributes()), h("span", null, t3.name, " (", e.formatFileSize(t3.size), ")"), h("button", Object.assign({ class: "alc-button alc-button-rounded", onClick: function() {
          return e.handleRemove(t3);
        }, "aria-label": "Remover arquivo ".concat(t3.name) }, testAttributes()), h("alc-icon", { name: "x", label: "Apagar" })));
      });
    };
    this.renderFileInfo = function() {
      var t3 = e.files.reduce(function(t4, e2) {
        return t4 + e2.size;
      }, 0);
      var r = e.formatFileSize(t3);
      var o = e.files.length;
      var i = o === 1 ? "arquivo" : "arquivos";
      return h("span", Object.assign({}, testAttributes()), "".concat(o, " ").concat(i, " (").concat(r, " no total)"));
    };
    this.renderPolite = function() {
      var t3 = "Nenhum arquivo selecionado.";
      if (e.files.length === 1) {
        t3 = "Arquivo selecionado: " + e.files[0].name;
      }
      if (e.files.length > 1) {
        var r = e.files.map(function(t4) {
          return t4.name;
        }).join("; ");
        t3 = e.files.length + " arquivos selecionados: " + r;
      }
      return h("span", { "aria-live": "polite", class: "sr-only", id: e.idInputFilePolite, role: "status" }, t3);
    };
    this.invokeFileInput = function() {
      var t3 = e.el.querySelector("#" + e.idInput);
      t3.click();
    };
    this.handleRemove = function(t3) {
      e.files = e.files.filter(function(e2) {
        return e2 !== t3;
      });
      var r = new DataTransfer();
      e.files.forEach(function(t4) {
        return r.items.add(t4);
      });
      var o = e.el.querySelector("#" + e.idInput);
      o.files = r.files;
      e.readFilesAndEmitEvent(e.files);
    };
    this.handleRemoveAll = function() {
      e.files = [];
      var t3 = e.el.querySelector("#" + e.idInput);
      t3.value = "";
      e.alcFileSelected.emit({ files: [] });
    };
    this.handleDrop = function(t3) {
      var r;
      t3.preventDefault();
      t3.stopPropagation();
      if (e.disabled) return;
      var o = (r = t3.dataTransfer) === null || r === void 0 ? void 0 : r.files;
      if (o && o.length > 0) {
        var i = Array.from(o);
        if (e.multiple) {
          e.files = __spreadArray(__spreadArray([], e.files, true), i, true);
        } else {
          e.files = [i[0]];
        }
        var a = new DataTransfer();
        e.files.forEach(function(t4) {
          return a.items.add(t4);
        });
        var n = e.el.querySelector("#" + e.idInput);
        n.files = a.files;
        e.readFilesAndEmitEvent(e.files);
      }
    };
    this.handleDragOver = function(t3) {
      t3.preventDefault();
      t3.stopPropagation();
    };
    this.handleDragEnter = function(t3) {
      t3.preventDefault();
      t3.stopPropagation();
      if (e.disabled) return;
      var r = t3.currentTarget;
      r.classList.add("alc-input-file__dropzone--dragover");
    };
    this.handleDragLeave = function(t3) {
      t3.preventDefault();
      t3.stopPropagation();
      if (e.disabled) return;
      var r = t3.currentTarget;
      r.classList.remove("alc-input-file__dropzone--dragover");
    };
  }
  t.prototype.getFiles = function() {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(i) {
        switch (i.label) {
          case 0:
            t2 = this.el.querySelector("#" + this.idInput);
            e = Array.from(t2.files || []);
            return [4, Promise.all(e.map(function(t3) {
              return __awaiter(o, void 0, void 0, function() {
                var e2;
                return __generator(this, function(r2) {
                  switch (r2.label) {
                    case 0:
                      return [4, t3.arrayBuffer()];
                    case 1:
                      e2 = r2.sent();
                      return [2, { file: t3, content: e2 }];
                  }
                });
              });
            }))];
  ...
  t.prototype.handleFileChange = function(t2) {
    var e = t2.target;
    var r = Array.from(e.files || []);
    this.files = r;
    this.readFilesAndEmitEvent(r);
  };
  t.prototype.readFilesAndEmitEvent = function(t2) {
    return __awaiter(this, void 0, void 0, function() {
      var e;
      var r = this;
      return __generator(this, function(o) {
        switch (o.label) {
          case 0:
            return [4, Promise.all(t2.map(function(t3) {
          ...
          case 1:
            e = o.sent();
            this.alcFileSelected.emit({ files: e });
            return [2];
        }
      });
    });
  };
  t.prototype.formatFileSize = function(t2) {
    var e = ["B", "KB", "MB", "GB", "TB"];
    var r = t2;
    var o = 0;
    while (r >= 1024 && o < e.length - 1) {
      r = r / 1024;
      o++;
    }
    return "".concat(r.toFixed(2), " ").concat(e[o]);
  };
  ...
  t.prototype.initializeResizeObserver = function() {
    var t2 = this;
  ...
  t.prototype.updateMaxInputTextLength = function() {
    if (!this.textInputElement) return;
    var t2 = this.textInputElement.offsetWidth;
    var e = this.files.length > 0 ? 28 : 0;
    var r = 12;
    if (this.iconName) {
      r = 40;
    }
    ...
    this.maxInputTextLength = l > 0 ? l : 10;
  };
  t.prototype.truncateText = function(t2, e) {
    if (t2.length <= e) {
      return t2;
    }
    return t2.substring(0, e - 3) + "...";
  };
  t.prototype.render = function() {
    var t2 = this;
    var e;
    (e = this.idInput) !== null && e !== void 0 ? e : logger.report("id-input", this.el.tagName.toLowerCase(), this.el);
    var r = { type: "file", id: this.idInput, class: "alc-input-file__input", multiple: this.multiple, accept: this.accept, disabled: this.disabled, onChange: function(e2) {
      return t2.handleFileChange(e2);
    }, required: this.required };
    var o = h("input", Object.assign({ key: "2035a612a2a06be66cadc9bb9abdbe14b4d3fea9" }, r, testAttributes()));
    var i = this.files.map(function(t3) {
      return t3.name;
    });
    var a = this.truncateText(i.join(", "), this.maxInputTextLength);
    var n = i.join(", ");
    return h(Host, { key: "4014a1d76f8469fff2c900d42e18c3a20d65dc41" }, h("slot", { key: "6fd005ff39bc1c29f968851f1bf9ed18996c0fbe" }), this.renderPolite(), this.mode === "button" && h("div", { key: "c52a0c22d813fa13ead54e4f68f3e0380d5e828d", class: "alc-input-file__field" }, h("button", Object.assign({ key: "b865bc268007d20fd5c314f8f4a205896085f0f1", class: "alc-button ".concat(this.buttonType === "secondary" ? "alc-button--secondary" : ""), onClick: this.invokeFileInput, disabled: this.disabled }, testAttributes()), h("span", { key: "2a9642c7d0a89f3aee66877527f75216d6110c7b", class: "alc-input-file__text-button" }, this.iconName && h("alc-icon", { key: "19fa2cb81759e3a26d5ef8d9908808d6346ab90f", name: this.iconName, label: "" }), this.multiple ? "Escolher arquivos" : "Escolher arquivo")), h("div", Object.assign({ key: "1c8a116685150a992bc2ef5dcb709bfea93f8a9c", class: "alc-input-file__content", "aria-controls": this.idInputFilePolite }, testAttributes()), this.files.length > 0 ? this.renderFiles() : h("small", { class: "alc-input-file__text" }, "Nenhum arquivo selecionado"))), this.mode === "input" && h("div", { key: "75a462b4ed59c6672ffd6b12352963449425bc93", class: "alc-input-file__field" }, h("div", { key: "5e9ede15d24855a494e4867936b8f352daa009e9", class: "alc-input-file__input-container" }, h("div", { key: "0f60d4544e6c10efa31b810e7c4b4054a8eaec3d", class: "alc-input-file__input-wrapper ".concat(this.iconName ? "alc-input-file__input-wrapper--with-icon" : "") }, this.iconName && h("alc-icon", { key: "5ac6e47aa8084c06754606436a125e687c803251", class: "alc-input-file__icon", name: this.iconName, label: "" }), h("input", Object.assign({ key: "f3dd7623af2747930fbe1792dcd660e3e4ec24e2", type: "text", class: "alc-input-file__text-input", readOnly: true, value: a, "aria-labelledby": this.idLabel, placeholder: "Selecione um arquivo", onClick: this.invokeFileInput, onKeyDown: function(e2) {
      if (e2.key === "Enter" || e2.key === " ") {
        e2.preventDefault();
        t2.invokeFileInput();
      }
    }, "aria-description": n }, testAttributes())), this.files.length > 0 && h("button", Object.assign({ key: "e57be5e726b1dffa4fe673e30ae076c78f118320", class: "alc-input-file__remove-button", onClick: this.handleRemoveAll, "aria-label": "Remover arquivos selecionados" }, testAttributes()), h("alc-icon", { key: "4ff389c91553e5061225f8a4090e7903de3edf13", name: "x", label: "Apagar" })))), h("div", { key: "113752296f8b66d3b204b3fcf266d71c4bd5171b", class: "alc-input-file__info" }, this.files.length > 0 ? this.renderFileInfo() : "")), this.mode === "dropzone" && h("div", { key: "e8b5fe04f1c073c067d81437294a988c99cd1a03", class: "alc-input-file__field" }, h("div", Object.assign({ key: "a340dfc0aa1387332820220db7052690278c1ac0", class: "alc-input-file__dropzone ".concat(this.disabled ? "alc-input-file__dropzone--disabled" : ""), onDrop: this.handleDrop, onDragOver: this.handleDragOver, onDragEnter: this.handleDragEnter, onDragLeave: this.handleDragLeave, role: "button", tabIndex: 0, "aria-labelledby": this.idLabel, "aria-describedby": this.idDropzoneText, onClick: this.invokeFileInput, onKeyDown: function(e2) {
      if (e2.key === "Enter" || e2.key === " ") {
        e2.preventDefault();
        t2.invokeFileInput();
      }
    } }, testAttributes()), this.iconName && h("alc-icon", { key: "e7335363a685a87839caa04eb07a7ec7904b33c3", name: this.iconName, label: "" }), h("span", { key: "d5299aa97c8d78ca42f0470898ace7e0e313bf8f", class: "alc-input-file__dropzone-text", id: this.idDropzoneText }, "Arraste e solte arquivos aqui ou clique para selecionar")), h("div", { key: "4a31ad607c0bc19d4eb4ba8848053a3f13ac1c2d", class: "alc-input-file__content", "aria-controls": this.idInputFilePolite }, this.files.length > 0 ? this.renderFiles() : "")), o);
  };
...
AlcInputFile.style = alcInputFileCss;
export {
  AlcInputFile as alc_input_file
};
