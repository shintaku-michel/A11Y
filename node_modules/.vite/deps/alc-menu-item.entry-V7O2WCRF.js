import {
  classNames
} from "./chunk-UNFBWMWE.js";
import "./chunk-IJMRG62Q.js";
import {
  Host,
  createEvent,
  getElement,
...
var AlcMenuItem = function() {
  ...
  e.prototype.handleKeyDown = function(e2) {
    if (" " === e2.key || "Enter" === e2.key) {
      e2.preventDefault();
      this.triggerEvent({ originalEvent: e2 });
    }
  };
  e.prototype.handleClick = function(e2) {
    if (!this.disabled) {
      e2.preventDefault();
      this.triggerEvent({ originalEvent: e2 });
    }
  };
  e.prototype.triggerEvent = function(e2) {
    if (this.disabled) {
      return;
    }
    this.alcSelect.emit(e2);
  };
  e.prototype.getCssClassMap = function() {
    return classNames("alc-menu-item", this.disabled && "alc-menu-item--disabled", this.type !== null && "alc-menu-item--checkable");
  };
  e.prototype.render = function() {
    var e2 = this.checked ? "true" : "false";
    var a = ROLES[this.type];
    return h(Host, { key: "048aa3032c7030740d576b35ed43ed9763e75f49", role: a, "aria-checked": this.type === "normal" ? null : e2, "aria-disabled": this.disabled ? "true" : null, class: this.getCssClassMap(), tabindex: -1 }, h("span", { key: "0401543277ca494a123c9ac64a2a21a32587123e", class: "alc-menu-item__check" }, this.type === "checkbox" && this.checked ? h("alc-icon", { label: "", name: "check" }) : this.type === "radio" && this.checked ? h("alc-icon", { label: "", name: "record-circle", class: "text-sm" }) : null), h("span", { key: "20d5ad331ca14ea6924bfb499dfeb6b9c981c31b", class: "alc-menu-item__prefix" }, h("slot", { key: "b9bb9e57ef0c413b91b4e80f00e4ad091a5673d8", name: "prefix" })), h("span", { key: "40e7fba648f5e6b42f4afd35ab6e911e006f5204", class: "alc-menu-item__label" }, h("slot", { key: "9a19ddeece85958962b7520828b835a0d957070c" })), h("span", { key: "54659f617b03600d2fecef7b209415b4db67ef00", class: "alc-menu-item__suffix" }, h("slot", { key: "b7935e91e087c73b855504c980e0950289e8e519", name: "suffix" })));
  };
...
AlcMenuItem.style = alcMenuItemCss;
export {
  AlcMenuItem as alc_menu_item
};
