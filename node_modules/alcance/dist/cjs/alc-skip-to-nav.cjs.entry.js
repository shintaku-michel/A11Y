...
const MD_BREAKPOINT = Number(tailwindScreens.screens.md.split('px')[0]);
    ...
    constructor(hostRef) {
        ...
        this.handleClick = (event) => {
            ...
            if (window.innerWidth < MD_BREAKPOINT) {
                ...
                if (!drawerButton) {
                    logger.logger.warn('O componente <alc-skip-to-nav> necessita de <alc-header> ou <alc-sidepanel> para funcionar corretamente no modo mobile.');
                    return;
                }
            ...
            if (navpanel) {
                if (navpanel.open) {
                    ...
                    if (nav) {
                        keydown.focusFirstElement(keydown.getFocusableElements(nav));
                        skipped = true;
                    }
                    else {
                        logger.logger.warn('Ao usar o <alc-nav-panel>, é necessário <alc-nav> dentro dele para <alc-skip-top-nav> funcionar corretamente.');
            ...
            if (sidepanel) {
                if (sidepanel.visible) {
                    ...
                    if (nav) {
                        ...
                        logger.logger.warn('Ao usar o <alc-sidepanel>, é necessário <alc-nav> dentro dele para <alc-skip-top-nav> funcionar corretamente.');
                        return; // Aqui, não há mais nada a fazer.
                    }
                }
            ...
            if (!skipped) {
                logger.logger.warn('O componente <alc-skip-to-nav> não localizou os elementos necessários para funcionar corretamente. Verifique a documentação do componente.');
            }
        };
    }
    render() {
        return (index.h(index.Host, { key: 'ef85488d12ccdc429fe6cea44e663702ab3d1aa1' }, index.h("a", { key: '17f46884a85c5ee1bdf93e73ebd6b71d203c9db9', class: 'alc-link text-center', href: '#', onClick: this.handleClick }, "Ir para navega\u00E7\u00E3o")));
    }
};
AlcSkipToNav.style = alcSkipToNavCss;

exports.alc_skip_to_nav = AlcSkipToNav;
//# sourceMappingURL=alc-skip-to-nav.entry.cjs.js.map

//# sourceMappingURL=alc-skip-to-nav.cjs.entry.js.map