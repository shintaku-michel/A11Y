...
const AlcDropdown = class {
    constructor(hostRef) {
        ...
        this.alcShow = index.createEvent(this, "alc-show", 7);
    ...
    handleContentFocus() {
        const contentFirstFocusable = keydown.getFocusableElements(this.content)[0];
    ...
    setTriggerAccessibility() {
        ...
        let id = (contentElementChild === null || contentElementChild === void 0 ? void 0 : contentElementChild.id) ? contentElementChild.id : getUniqueId.getUniqueId();
    ...
    getTrigger() {
        ...
        if (trigger === null) {
            logger.logger.warn(this.el, 'alc-dropdown não localizou um trigger válido. Slot deve ser ou conter um botão. Veja a documentação para mais detalhes.');
        }
        return trigger;
    }
    componentDidLoad() {
    ...
    render() {
        return (index.h(index.Host, { key: '2a3cb9758c23c1f7f895322bffa6893a4680e1e8' }, index.h("alc-popup", { key: '0c352d9d09c09df64e50c0561633120705875ef1', active: this.open, placement: "bottom-start", flip: true, shift: true, strategy: "fixed", onFocusout: this.handleFocusOut.bind(this), distance: 2 }, index.h("div", { key: '6b60a206a5a326e53c1f3afed07b0e53b52c9832', slot: "anchor", onClick: this.handleAnchorClick }, index.h("slot", { key: '528d7a27ebf5bdc884d89796d3aec84ae19e18e5', name: "trigger" })), index.h("div", { key: '2407874043bb9e9cabfaf9bc13751040f15f0c18', class: "alc-dropdown__content", ref: (el) => this.content = el, tabindex: '-1' }, index.h("slot", { key: 'ecd68a468c536a351baa3c5eb75fad9fbd88c2b4' })))));
    }
...
const AlcMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2aa137629ce5187b9191d9885a0b716d51ef4861', role: "menu", class: "alc-menu" }, index.h("slot", { key: '6442d2320bb9c5b2f83859688fb464ac5ab903da' })));
    }
    get hostElement() { return index.getElement(this); }
};
AlcMenu.style = alcMenuCss;

exports.alc_dropdown = AlcDropdown;
exports.alc_menu = AlcMenu;
//# sourceMappingURL=alc-dropdown.alc-menu.entry.cjs.js.map

//# sourceMappingURL=alc-dropdown_2.cjs.entry.js.map