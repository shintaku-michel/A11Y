...
const alcPopupCss = ":host{display:block}alc-popup{position:relative;display:inline-block}.alc-popup__content{position:absolute;top:0px;left:0px;z-index:1060;display:none;width:-moz-max-content;width:-webkit-max-content;width:max-content}.alc-popup__content--active{display:block}.alc-popup__content--fixed{position:fixed}.alc-popup__arrow{position:absolute}";

const AlcPopup = class {
    constructor(hostRef) {
    ...
    render() {
        return (index.h(index.Host, { key: 'b0d9dc5b6ecaea7e890b354ad784867477c746b2' }, index.h("div", { key: 'aad811091ef55a2ef72eed027e63ceea97a358cc', ref: (el) => this.anchorEl = el }, index.h("slot", { key: 'baba256e7df545e6fc6c667e03ff2344f2013db1', name: "anchor" })), index.h("div", { key: 'ab9285834ac4eb48c8633cc6adc336589e87660e', class: {
                'alc-popup__content': true,
                'alc-popup__content--active': this.active,
                'alc-popup__content--fixed': this.strategy === 'fixed',
            }, ref: (el) => this.popupEl = el }, index.h("slot", { key: 'a702544be7061ef03f84d75cd9cafb7e2bb933e9' }), index.h("div", { key: '6e1f20ded951cfacfd406820d08637e7dff76c93', ref: (el) => this.arrowEl = el, class: this.arrow ? 'alc-popup__arrow' : '' }))));
    }
...
exports.alc_popup = AlcPopup;
//# sourceMappingURL=alc-popup.entry.cjs.js.map

//# sourceMappingURL=alc-popup.cjs.entry.js.map