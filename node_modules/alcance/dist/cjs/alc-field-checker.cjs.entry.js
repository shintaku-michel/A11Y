...
const alcFieldCheckerCss = ".alc-field-checker{display:block}";

const AlcFieldChecker = class {
    constructor(hostRef) {
    ...
    componentWillLoad() {
        this.idAlert = getUniqueId.getUniqueId();
    }
    componentDidLoad() {
    ...
    render() {
        return (index.h("div", { key: '0a9dfd4e96e62c36ef0cc1b9a3a82b943e0bfd9c', class: "alc-field-checker" }, this.errorFields.length > 0 && (index.h("alc-alert", { key: '65030b9165d9c7909cafc0b22a5a1b456e27c768', id: this.idAlert, type: "warning", dismissible: false }, index.h("span", { key: '9db85f42ff4ea2ec8103cc501e5a602e1a592e04', class: 'alc-alert__summary' }, "Aten\u00E7\u00E3o: Seu formul\u00E1rio cont\u00E9m ", this.errorFields.length, " ", this.errorFields.length > 1 ? "erros" : "erro"), index.h("ul", { key: 'c724032a1d6eaa5a0cea7cef9f40d3d8be0069f3' }, this.errorFields.map((field) => (index.h("li", null, index.h("a", { href: `#${field.id}`, class: "alc-link alc-link--color-text" }, index.h("strong", null, field.label, ":"), " ", field.errorMsg))))))), index.h("slot", { key: '72e09b858f27172b05f0df38c8c6f9dca12a0ae6' })));
    }
    get hostElement() { return index.getElement(this); }
};
AlcFieldChecker.style = alcFieldCheckerCss;

exports.alc_field_checker = AlcFieldChecker;
//# sourceMappingURL=alc-field-checker.entry.cjs.js.map

//# sourceMappingURL=alc-field-checker.cjs.entry.js.map