...
var theme = require('./theme-P2DHLxHb.js');
...
const AlcField = class {
    ...
    watchErrorMsg(newValue) {
        logger.logger.debug('watchErrorMsg', newValue, this.input);
        if (newValue) {
    ...
    async componentDidLoad() {
        ...
        if (this.slottedElement) {
            ...
            if (this.input) {
                this.input.id = this.input.id || getUniqueId.getUniqueId();
    ...
    render() {
        return (index.h(index.Host, { key: 'f2eb4d7cb47f480863125057a87e555253fa8565', class: {
                'alc-field': true,
            } }, this.label
            ?
                index.h("div", null, " ", index.h("label", { class: "alc-field__label", htmlFor: this.inputId }, this.label, this.required
                    ?
                    ...
                    :
                        null))
            :
                index.h("slot", { name: "label" }), index.h("div", { key: 'd58883931ed0328c2ec0256fc0651681d1e1be4e', class: "alc-field__core" }, index.h("slot", { key: '598479d10425fc2dfa00d3870b8193d7cf423e84' }), this.errorMsg
            ?
                index.h("small", { class: "alc-field__text alc-field__text--error", id: this.errorId }, this.errorMsg)
            :
                null, this.hint
            ?
                index.h("small", { class: "alc-field__text", id: this.hintId }, this.hint)
            :
                null)));
    }
...
const AlcTheme = class {
    ...
    change(theme$1) {
        logger.logger.log('changed to', theme$1);
        switch (theme$1) {
            case LIGHT_THEME:
                theme.setAppliedTheme('light');
                theme.saveUserPreference('light');
                break;
            case DARK_THEME:
                theme.setAppliedTheme('dark');
                theme.saveUserPreference('dark');
                break;
            default:
                theme.setAppliedTheme(theme.getAppliedTheme('system'));
                theme.removeUserPreference();
                break;
        }
    ...
    componentWillLoad() {
        const userPreference = theme.loadUserPreference();
        ...
        this.selectId = getUniqueId.getUniqueId();
    }
    render() {
        return (index.h(index.Host, { key: '1303b40b7cf8291232126b54294abfeea9907b16' }, index.h("alc-field", { key: '6091a7a2ad536f854c532ce898fd40b7b4479ca9' }, index.h("label", Object.assign({ key: '8570c6bf2d41e99c4ef01b14f209613a82117b36', htmlFor: this.selectId, slot: "label", class: "alc-theme__label" }, testAttributes.testAttributes()), "Tema"), index.h("div", { key: 'b3e55038e3df6b4dc75e8b3d1ff71d0960d9a087' }, index.h("select", Object.assign({ key: 'aa73b515c5aa45ec04faaffff8e3948511f756ed', onChange: (e) => this.change(this.getSelectedValue(e.target)), class: "alc-theme__select", id: this.selectId }, testAttributes.testAttributes()), index.h("option", { key: 'c7b043b78f2c693051cb710ce12f51fe17139c16', value: NO_THEME, selected: this.selectedTheme === NO_THEME }, "Do Sistema", this.selectedTheme === NO_THEME ? ' ✔' : ''), index.h("option", { key: '66b49cf0fb421ae680c2b3750fbec2290676a532', value: LIGHT_THEME, selected: this.selectedTheme === LIGHT_THEME }, "Claro", this.selectedTheme === LIGHT_THEME ? ' ✔' : ''), index.h("option", { key: '86181cfa6e6507d83abc9f1cd0cef398a9c403d1', value: DARK_THEME, selected: this.selectedTheme === DARK_THEME }, "Escuro", this.selectedTheme === DARK_THEME ? ' ✔' : ''))))));
    }
};
AlcTheme.style = {
...
exports.alc_field = AlcField;
exports.alc_theme = AlcTheme;
//# sourceMappingURL=alc-field.alc-theme.entry.cjs.js.map

//# sourceMappingURL=alc-field_2.cjs.entry.js.map