...
const AlcTooltip = class {
    constructor(hostRef) {
        ...
        this.alcAfterHide = index.createEvent(this, "alc-after-hide", 7);
        this.contentId = null;
    ...
    */
    ...
    componentWillLoad() {
        this.contentId = getUniqueId.getUniqueId();
    }
    componentDidLoad() {
        if (this.anchorSlot) {
    ...
    render() {
        return (index.h(index.Host, { key: 'b0c78d43c4d9c151ffb324428231f3d8613f8af9' }, index.h("alc-popup", { key: 'e92d111b22fa9e003a7ac7a8e0312a44c94d5c8b', active: this.active, placement: this.placement, shift: true, flip: true, distance: 8, arrow: true, role: "tooltip", strategy: this.strategy }, index.h("div", Object.assign({ key: '264958b7e8045ffe845f990a92dcf27307713af6', slot: "anchor" }, testAttributes.testAttributes()), index.h("slot", { key: 'a76cf9f9d1f4f97b4375434ebbc41299892ca376', name: "trigger", ref: (el) => this.anchorSlot = el })), index.h("div", Object.assign({ key: '0f959b9b6533f7b6ab9ab4fb6448b12b7e560a2b', class: "alc-tooltip__content", id: this.contentId }, testAttributes.testAttributes()), index.h("slot", { key: '8e034dbfcfe8f5a2f513fb952570ff288c459f10' }, this.content)))));
    }
...
exports.alc_tooltip = AlcTooltip;
//# sourceMappingURL=alc-tooltip.entry.cjs.js.map

//# sourceMappingURL=alc-tooltip.cjs.entry.js.map