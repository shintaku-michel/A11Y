...
const AlcDrawer = class {
    ...
    */
    handleKeyDown(event) {
        ...
        if (event.key !== 'Tab')
            return;
        const focusableElements = keydown.getFocusableElements(this.drawerRef);
    ...
    render() {
        return (index.h(index.Host, { key: 'ca2677c0cd1d14c67bafa67fce53f5b424f4685e', style: { display: this.isVisible ? 'block' : 'none' } }, index.h("div", { key: '8acd999442e9acf8a2e809cfa7815da89eee94cb', class: "alc-drawer__overlay" }, index.h("div", { key: 'fb8f0c024488670e1b8d2ecdb127bf3932b12571', class: "alc-drawer__content bg-white dark:bg-black", role: "dialog", "aria-modal": "true", ref: this.getDrawerRef }, index.h("div", { key: '849e2ea5ff524e1d38e56f9d8927dfccf7f0a4d9', class: "alc-drawer__header" }, index.h("button", Object.assign({ key: '4c1cb2eeb3873269d1e22c2562aca16194483c0f', class: "alc-button alc-button-rounded", onClick: () => this.hide() }, testAttributes.testAttributes()), index.h("alc-icon", Object.assign({ key: '3d49c3ad15ddaa614ff1c247de746248e94c498b', name: "x-lg", label: "Fechar Drawer" }, testAttributes.testAttributes())))), index.h("div", { key: 'ece60e72f6084d1a481561acb9978f769e4178d3' }, index.h("slot", { key: '8c460fb7b5dcc59fe786028b1a7557e0308f5b7c' }))))));
    }
...
exports.alc_drawer = AlcDrawer;
//# sourceMappingURL=alc-drawer.entry.cjs.js.map

//# sourceMappingURL=alc-drawer.cjs.entry.js.map