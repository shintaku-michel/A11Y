...
const AlcNav = class {
    ...
    openPanel(panel) {
        ...
        logger.logger.debug('open', { panel });
        ...
        listitems.forEach((item) => {
            if (item.id === (current === null || current === void 0 ? void 0 : current.dataset.alcParent)) {
                logger.logger.debug('focus on', item, item.id);
                item.querySelector('a').focus();
            }
        });
    }
    closePanel(panel) {
        logger.logger.debug('close', { panel });
    }
    /**
    ...
    async togglePanel(panel) {
        ...
        if (listItem.classList.contains('is-open')) {
            logger.logger.debug('will close', panel);
            this.closePanel(panel);
        }
        else {
            logger.logger.debug('will open', panel);
    ...
    initPanel(panel) {
        ...
        logger.logger.debug({ panel });
        panel.id = panel.id || getUniqueId.getUniqueId();
    ...
    initListview(listview) {
        ...
        if (hasLabel) {
            ...
            previous.id = previous.id || getUniqueId.getUniqueId();
    ...
    initSubPanel(subpanel) {
        ...
        listitem.id = listitem.id || getUniqueId.getUniqueId();
        subpanel.id = subpanel.id || getUniqueId.getUniqueId();
    ...
    render() {
        return (index.h(index.Host, { key: '4869774167e9dd1f9b2b7e21a8c164c331086398', class: { 'alc-nav': true, 'alc-nav__wrapper': true } }, index.h("nav", { key: '66fdea76c8704b5630205260fdf370f3c3d47ad0', ref: el => this.menu = el, class: "alc-nav__menu" }, index.h("div", { key: 'ea80376803eb2b26bea0d0f827892146be384b4d', "data-alc-panel": true }, this.header ? (index.h("div", { class: "alc-nav__header" }, index.h("slot", { name: "header" }))) : null, index.h("div", { key: 'dced630d3b584b25efb5f69b78d60baad2ccc21c', class: "alc-nav__main", ref: el => this.main = el }, index.h("slot", { key: '1be8b67e85921d8315102090094416ab9d333ce8' })), this.footer ? (index.h("div", { class: "alc-nav__footer" }, index.h("slot", { name: "footer" }))) : null))));
    }
    get el() { return index.getElement(this); }
};
AlcNav.style = alcNavCss;

exports.alc_nav = AlcNav;
//# sourceMappingURL=alc-nav.entry.cjs.js.map

//# sourceMappingURL=alc-nav.cjs.entry.js.map