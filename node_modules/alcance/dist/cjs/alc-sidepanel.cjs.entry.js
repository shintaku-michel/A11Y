...
const MOBILE_BREAKPOINT = Number(tailwindScreens.screens.md.split('px')[0]);
const DEFAULT_STATE = {
    visible: true
};
const AlcSidepanel = class {
    constructor(hostRef) {
        ...
        this.visible = true;
        this.renderMobile = () => ([
            index.h("button", Object.assign({ class: "alc-button alc-button-rounded absolute right-2 -mt-[3.25rem] text-white", onClick: () => this.drawer.show() }, testAttributes.testAttributes(), { "data-alc-sidepanel-drawer-button": true }), index.h("alc-icon", { name: "list", label: "Abrir" })),
            index.h("alc-drawer", { "onSl-show": () => this.visible = true, "onSl-hide": () => this.visible = false, ref: el => this.drawer = el }, index.h("div", { ref: el => this.mobileSlot = el }))
        ]);
    }
    /**
     * Abre o sidepanel.
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'faeacb3a035ddcb2f77951759e3fabf13f055aa9', class: "alc-sidepanel" }, index.h("div", { key: '1b168abcc82fbad96e26743ad6ef750083e0aac8', ref: el => this.slotContainer = el }, index.h("slot", { key: '6d8bd910fe70f5c65f122c7d9f6cbc951cd8ed4c' })), index.h("div", { key: '677d9bcdb77d68b05dbeef0933aca74f3f4fb929', class: {
                'alc-sidepanel__mobile-container': true,
            } }, this.renderMobile()), index.h("div", { key: 'f5efb3e8a82ed58eabeca33939da1f8ae65eb6c5', class: {
                'alc-sidepanel__desktop-container': true,
            } }, index.h("button", Object.assign({ key: '0c15d78e6ba75a566173b4cb55e3e41dc3585588', type: "button", class: "alc-button alc-button-rounded fixed left-2 -mt-[3.75rem] text-white z-[1020] focus-visible:outline-2 focus-visible:outline-white", onClick: () => this.visible ? this.hide() : this.show(), "aria-pressed": this.visible ? 'true' : 'false' }, testAttributes.testAttributes(), { "data-alc-sidepanel-button": true }), index.h("alc-icon", { key: '79b13d7cc336a82bc4c7fa2856fbe5275fb59996', name: "list", label: "Exibir navega\u00E7\u00E3o" })), index.h("div", { key: '1d694d33e34441ae63b323d69249dddddb942e3e', ref: el => this.desktopSlot = el, class: {
    ...
    setOffset() {
        const top = document.querySelector('[data-alc-top]');
        logger.logger.debug(top.offsetHeight);
...
exports.alc_sidepanel = AlcSidepanel;
//# sourceMappingURL=alc-sidepanel.entry.cjs.js.map

//# sourceMappingURL=alc-sidepanel.cjs.entry.js.map