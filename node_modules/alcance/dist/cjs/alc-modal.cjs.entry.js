...
const AlcModal = class {
    ...
    watchOpen(open) {
        if (open) {
            ...
            scrollLockManager.lockBodyScroll();
        }
        else {
            // Hide
            ...
            if (!defaultPreventedFocus) {
                this.handleFocusWhenCloseModal();
                scrollLockManager.unlockBodyScroll();
            }
        }
    }
    /**
    ...
    handleKeyDown(event) {
        ...
        if (event.key !== 'Tab')
            return;
        const focusableElements = keydown.getFocusableElements(this.modalRef);
        keydown.handleKeyDown(event, focusableElements);
    }
    componentWillLoad() {
        // Antes do componente carregar, cria um id para o titulo da modal (Acessibilidade).
        this.idModalTitle = getUniqueId.getUniqueId();
    }
    componentDidRender() {
        ...
        if (this.open) {
            keydown.focusFirstElement(focusableElements);
        }
    }
    connectedCallback() {
        if (this.open) {
    ...
    render() {
        return (index.h(index.Host, { key: '8df9b10e800caa99c53028e32433128b72da1497', style: { display: this.open ? 'block' : 'none' } }, index.h("div", { key: '9f19c7aa8381b24d765bee25ef7451140fe4fe66', class: "alc-modal__base" }, index.h("div", Object.assign({ key: '639800fce03bf27e4648c4ca8d8bf7ebcb8db5e2', class: "alc-modal__overlay", onClick: (e) => this.handleOutsideClick(e) }, testAttributes.testAttributes(), { ref: el => this.overlayRef = el })), index.h("div", { key: 'de7683718c16ad92d2e2a203c4de14306cfd35ef', class: {
            ...
            }, role: "dialog", "aria-modal": "true", "aria-labelledby": this.idModalTitle, ref: this.getModalRef }, index.h("div", { key: 'b8f6dd643bb6ddb909cd5c101ca25d53b0e253dd', class: "alc-modal__header" }, this.headerText ? (index.h("h2", { id: this.idModalTitle, class: "alc-modal__title" }, this.headerText)) : (index.h("slot", { name: "header" })), index.h("button", Object.assign({ key: '9bb4fe3fecc1ae3be0efd1bbd862696cbe55a1e7', type: "button", class: "alc-button alc-button-rounded", onClick: () => this.handleHideByUser('header-button') }, testAttributes.testAttributes()), index.h("alc-icon", Object.assign({ key: '43e419c1b7badb46c95a5e2ae5789edbd7c782b2', name: "x-lg", label: "Fechar Modal" }, testAttributes.testAttributes())))), index.h("div", { key: '3ae84356e5d7842d24d6a4d166dae9b99ccc756b', class: "alc-modal__content" }, index.h("slot", { key: '91e0a806036b3b5f0f7179d227912d96c707cf0b' })), index.h("div", { key: '3b567a11e954c34183af1628b71d16322b0c7210', class: "alc-modal__footer" }, index.h("slot", { key: '5e3678855e574f4885aea217b4ab0519d6d14a4a', name: "footer" }, index.h("button", Object.assign({ key: '68a0b787119f1662e9f03a02c536850ce8244d5e', type: "button", class: "alc-button alc-button-primary", onClick: () => this.handleHideByUser('footer-button') }, testAttributes.testAttributes()), "Fechar")))))));
    }
...
AlcModal.style = {
    base: alcModalBaseCss,
    theme: themeAlcModalCss
};

exports.alc_modal = AlcModal;
//# sourceMappingURL=alc-modal.entry.cjs.js.map

//# sourceMappingURL=alc-modal.cjs.entry.js.map