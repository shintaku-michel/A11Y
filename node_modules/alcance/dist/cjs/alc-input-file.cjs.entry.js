...
const AlcInputFile = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.alcFileSelected = index.createEvent(this, "alc-file-selected", 7);
        ...
        this.renderFiles = () => {
            return this.files.map(file => (index.h("div", Object.assign({ class: "alc-input-file__file" }, testAttributes.testAttributes()), index.h("span", null, file.name, " (", this.formatFileSize(file.size), ")"), index.h("button", Object.assign({ class: "alc-button alc-button-rounded", onClick: () => this.handleRemove(file), "aria-label": `Remover arquivo ${file.name}` }, testAttributes.testAttributes()), index.h("alc-icon", { name: "x", label: "Apagar" })))));
        };
        this.renderFileInfo = () => {
            ...
            return (index.h("span", Object.assign({}, testAttributes.testAttributes()), `${fileCount} ${fileText} (${totalSizeFormatted} no total)`));
        };
        this.renderPolite = () => {
            ...
            return (index.h("span", { "aria-live": "polite", class: "sr-only", id: this.idInputFilePolite, role: "status" }, politeText));
        };
    ...
    componentWillLoad() {
        ...
        this.idInputFilePolite = getUniqueId.getUniqueId();
        this.idLabel = getUniqueId.getUniqueId();
        this.idDropzoneText = getUniqueId.getUniqueId();
    }
    componentDidLoad() {
        if (this.mode === 'input') {
    ...
    render() {
        var _a;
        (_a = this.idInput) !== null && _a !== void 0 ? _a : logger.logger.report('id-input', this.el.tagName.toLowerCase(), this.el);
        ...
        const fileInput = index.h("input", Object.assign({ key: '2035a612a2a06be66cadc9bb9abdbe14b4d3fea9' }, inputAttributes, testAttributes.testAttributes()));
        ...
        return (index.h(index.Host, { key: '4014a1d76f8469fff2c900d42e18c3a20d65dc41' }, index.h("slot", { key: '6fd005ff39bc1c29f968851f1bf9ed18996c0fbe' }), this.renderPolite(), this.mode === 'button' && (index.h("div", { key: 'c52a0c22d813fa13ead54e4f68f3e0380d5e828d', class: "alc-input-file__field" }, index.h("button", Object.assign({ key: 'b865bc268007d20fd5c314f8f4a205896085f0f1', class: `alc-button ${this.buttonType === 'secondary' ? 'alc-button--secondary' : ''}`, onClick: this.invokeFileInput, disabled: this.disabled }, testAttributes.testAttributes()), index.h("span", { key: '2a9642c7d0a89f3aee66877527f75216d6110c7b', class: "alc-input-file__text-button" }, this.iconName && index.h("alc-icon", { key: '19fa2cb81759e3a26d5ef8d9908808d6346ab90f', name: this.iconName, label: "" }), this.multiple ? 'Escolher arquivos' : 'Escolher arquivo')), index.h("div", Object.assign({ key: '1c8a116685150a992bc2ef5dcb709bfea93f8a9c', class: "alc-input-file__content", "aria-controls": this.idInputFilePolite }, testAttributes.testAttributes()), this.files.length > 0 ? (this.renderFiles()) : (index.h("small", { class: "alc-input-file__text" }, "Nenhum arquivo selecionado"))))), this.mode === 'input' && (index.h("div", { key: '75a462b4ed59c6672ffd6b12352963449425bc93', class: "alc-input-file__field" }, index.h("div", { key: '5e9ede15d24855a494e4867936b8f352daa009e9', class: "alc-input-file__input-container" }, index.h("div", { key: '0f60d4544e6c10efa31b810e7c4b4054a8eaec3d', class: `alc-input-file__input-wrapper ${this.iconName ? 'alc-input-file__input-wrapper--with-icon' : ''}` }, this.iconName && (index.h("alc-icon", { key: '5ac6e47aa8084c06754606436a125e687c803251', class: "alc-input-file__icon", name: this.iconName, label: "" })), index.h("input", Object.assign({ key: 'f3dd7623af2747930fbe1792dcd660e3e4ec24e2', type: "text", class: "alc-input-file__text-input", readOnly: true, value: inputTextValue, "aria-labelledby": this.idLabel, placeholder: "Selecione um arquivo", onClick: this.invokeFileInput, onKeyDown: (e) => {
                if (e.key === 'Enter' || e.key === ' ') {
                    e.preventDefault();
                    this.invokeFileInput();
                }
            }, "aria-description": inputTitle }, testAttributes.testAttributes())), this.files.length > 0 && (index.h("button", Object.assign({ key: 'e57be5e726b1dffa4fe673e30ae076c78f118320', class: "alc-input-file__remove-button", onClick: this.handleRemoveAll, "aria-label": "Remover arquivos selecionados" }, testAttributes.testAttributes()), index.h("alc-icon", { key: '4ff389c91553e5061225f8a4090e7903de3edf13', name: "x", label: "Apagar" }))))), index.h("div", { key: '113752296f8b66d3b204b3fcf266d71c4bd5171b', class: "alc-input-file__info" }, this.files.length > 0 ? this.renderFileInfo() : ''))), this.mode === 'dropzone' && (index.h("div", { key: 'e8b5fe04f1c073c067d81437294a988c99cd1a03', class: "alc-input-file__field" }, index.h("div", Object.assign({ key: 'a340dfc0aa1387332820220db7052690278c1ac0', class: `alc-input-file__dropzone ${this.disabled ? 'alc-input-file__dropzone--disabled' : ''}`, onDrop: this.handleDrop, onDragOver: this.handleDragOver, onDragEnter: this.handleDragEnter, onDragLeave: this.handleDragLeave, role: "button", tabIndex: 0, "aria-labelledby": this.idLabel, "aria-describedby": this.idDropzoneText, onClick: this.invokeFileInput, onKeyDown: (e) => {
                if (e.key === 'Enter' || e.key === ' ') {
                    e.preventDefault();
                    this.invokeFileInput();
                }
            } }, testAttributes.testAttributes()), this.iconName && index.h("alc-icon", { key: 'e7335363a685a87839caa04eb07a7ec7904b33c3', name: this.iconName, label: "" }), index.h("span", { key: 'd5299aa97c8d78ca42f0470898ace7e0e313bf8f', class: "alc-input-file__dropzone-text", id: this.idDropzoneText }, "Arraste e solte arquivos aqui ou clique para selecionar")), index.h("div", { key: '4a31ad607c0bc19d4eb4ba8848053a3f13ac1c2d', class: "alc-input-file__content", "aria-controls": this.idInputFilePolite }, this.files.length > 0 ? (this.renderFiles()) : ('')))), fileInput));
    }
    get el() { return index.getElement(this); }
};
AlcInputFile.style = alcInputFileCss;

exports.alc_input_file = AlcInputFile;
//# sourceMappingURL=alc-input-file.entry.cjs.js.map

//# sourceMappingURL=alc-input-file.cjs.entry.js.map