...
const setup = (value, domain = [], defaultValue) => {
    ...
    if (!domain.includes(value)) {
        logger.logger.warn(`"${value}" não é um valor válido; usando o valor padrão "${defaultValue}"`);
        return defaultValue;
    }
    return value;
};
...
const Alert = class {
    ...
    renderIcon() {
        ...
        return index.h("alc-icon", { name: icon.name, label: icon.label });
    }
    /*
    ...
    renderDismissButton() {
        ...
        return (index.h("div", Object.assign({ class: "alc-alert__dismiss" }, testAttributes.testAttributes()), index.h("button", { class: `alc-button alc-button-rounded alc-button-rounded--${this.core.type}`, onClick: () => this.hide() }, index.h("alc-icon", { name: "x-lg", label: "Dispensar" }))));
    }
    componentDidRender() {
     ...
     */
    render() {
        logger.logger.debug('render alc-alert', ALC);
        return (index.h(index.Host, { key: '659c2cf489d4d1a8da0fc8e6aed725322c9dc38a', style: { display: this.visible ? null : 'none' } }, index.h("div", { key: 'ce93997657b175b0bebf0fb616f21ecb37738832', class: "alc-alert alc-alert--" + this.core.type }, this.renderIcon(), index.h("div", { key: '9ad2f7bf6903e63c8e123df01a73f510c6164d3c', class: 'alc-alert__content' }, index.h("div", { key: '9b3168c210ad5b525c7a34a5273008c06f5d1e73', class: "alc-alert__summary" }, index.h("slot", { key: '3eebdf45b31d6f86cb5a5d3d6e366e0c062be2ee', name: "summary" })), index.h("slot", { key: '237e8b7b3dc224f3e37040be1746bfe15190d998' })), this.renderDismissButton())));
    }
...
exports.alc_alert = Alert;
//# sourceMappingURL=alc-alert.entry.cjs.js.map

//# sourceMappingURL=alc-alert.cjs.entry.js.map