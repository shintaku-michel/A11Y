...
const AlcDetails = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.alcShow = index.createEvent(this, "alc-show", 7);
        this.alcClose = index.createEvent(this, "alc-close", 6);
        this.idDetails = null;
        /**
         * Mantém aberto.
         */
    ...
    renderIcon() {
        ...
        if (theme.getMode() === 'base') {
            return null;
        }
        return (index.h("alc-icon", { name: "chevron-right", label: "Expandir", class: {
    ...
    componentWillLoad() {
        ...
        this.idDetails = getUniqueId.getUniqueId();
    }
    componentDidLoad() {
    ...
    render() {
        var _a;
        (_a = this.summary) !== null && _a !== void 0 ? _a : logger.logger.report('summary', this.element.tagName.toLowerCase(), this.element);
        return (index.h(index.Host, { key: '82b4dabe8a69e6b2eec1eba297a065931cf8e1fe' }, index.h("details", { key: '4f8d568957333eb6c9f41485c654daacf8eda14c', id: this.idDetails, open: this.opened, class: {
                'alc-details': true,
                'is-disabled': this.disabled,
                'is-open': this.opened,
            }, ref: el => (this.detailsElement = el) }, index.h("summary", { key: 'b1be29ff426173d74fc28366996a668ce7c090c4', class: {
                'alc-details__summary': true,
                'is-disabled': this.disabled,
                'is-open': this.opened
            } }, this.renderIcon(), this.summary), index.h("div", { key: 'a5d050ec9d369667b5a4abb954f6dadacd9152ad', class: "alc-details__content" }, index.h("slot", { key: '1fe678e8072aa8f4cd430041dca81d0ba23241e2' })))));
    }
...
exports.alc_details = AlcDetails;
//# sourceMappingURL=alc-details.entry.cjs.js.map

//# sourceMappingURL=alc-details.cjs.entry.js.map