import { d as getAssetPath, r as registerInstance, h, H as Host, g as getElement } from './index-BuFKlV49.js';
...
const AlcIcon = class {
    ...
    render() {
        ...
        return (h(Host, Object.assign({ key: 'd9c68737d9c24cc00a11fb0f95d44529b2093f1e', label: label, "aria-label": ariaLabel !== undefined && !this.hasAriaHidden() ? ariaLabel : null, role: role, class: {
            ...
            } }, inheritedAttributes), this.svgContent ? (h("span", { class: "icon-inner", innerHTML: this.svgContent })) : (h("span", { class: "icon-inner" }, label))));
    }
