...
const AlcInputFile = class {
    constructor(hostRef) {
        ...
        this.renderFiles = () => {
            return this.files.map(file => (h("div", Object.assign({ class: "alc-input-file__file" }, testAttributes()), h("span", null, file.name, " (", this.formatFileSize(file.size), ")"), h("button", Object.assign({ class: "alc-button alc-button-rounded", onClick: () => this.handleRemove(file), "aria-label": `Remover arquivo ${file.name}` }, testAttributes()), h("alc-icon", { name: "x", label: "Apagar" })))));
        };
        this.renderFileInfo = () => {
            ...
            return (h("span", Object.assign({}, testAttributes()), `${fileCount} ${fileText} (${totalSizeFormatted} no total)`));
        };
        this.renderPolite = () => {
    ...
    render() {
        ...
        const fileInput = h("input", Object.assign({ key: '2035a612a2a06be66cadc9bb9abdbe14b4d3fea9' }, inputAttributes, testAttributes()));
...
export { AlcInputFile as alc_input_file };
//# sourceMappingURL=alc-input-file.entry.js.map
