import { r as registerInstance, h, H as Host, g as getElement, c as createEvent } from './index-BuFKlV49.js';
...
const AlcLoading = class {
    ...
    render() {
        ...
        return (h(Host, { key: '4e4d1315ccbcbd55c2718dd8421845ab217901fa' }, this.renderLoadingVisuals(), shouldRenderAriaLive && (h("div", Object.assign({ key: 'eab510d1080f9a3d1ec98600f86621a4faf99765', class: "sr-only", "aria-live": "polite", role: "status" }, testAttributes()), this.ariaMessage))));
    }
        ...
        */
        ...
        this.renderPaginationItem = (pageNumber, using) => {
            ...
            return (h("li", null, h("button", Object.assign({ onClick: () => this.handleChangePage(pageNumber, using), class: {
                ...
                }, "aria-label": this.paginationItem[using].label + paginationItemLabel, "aria-disabled": paginationItemIsDisabled, disabled: paginationItemIsDisabled }, testAttributes()), h("alc-icon", { name: this.paginationItem[using].icon, label: "" }))));
        };
    }
...
export { AlcLoading as alc_loading, Pagination as alc_pagination, AlcSortIndicator as alc_sort_indicator };
//# sourceMappingURL=alc-loading.alc-pagination.alc-sort-indicator.entry.js.map
