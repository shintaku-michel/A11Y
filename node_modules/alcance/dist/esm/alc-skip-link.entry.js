...
const AlcSkipLink = class {
    ...
    render() {
        return (h(Host, { key: '210b83f0a75914208b091cb3503bf36046fd2f3c' }, h("a", Object.assign({ key: 'c85b6203d3041a7559e60621878c21a2c6285fa2', class: 'alc-link text-center', href: `#${this.anchor}` }, testAttributes(), { onClick: this.handleClick }), "Ir para ", h("slot", { key: '4b14b6ff834a9052f00a27c22abbdd4984432481' }))));
    }
};
AlcSkipLink.style = alcSkipLinkCss;

export { AlcSkipLink as alc_skip_link };
