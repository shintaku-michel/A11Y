...
const AlcPopup = /*@__PURE__*/ proxyCustomElement(class AlcPopup extends HTMLElement$1 {
    constructor() {
        super();
        this.__registerHost();
        this.padding = 8;
    ...
    static get style() { return alcPopupCss; }
}, [4, "alc-popup", {
        "active": [1540],
        "placement": [513],
        "flip": [516],
...
function defineCustomElement() {
    ...
    const components = ["alc-popup"];
    components.forEach(tagName => { switch (tagName) {
        case "alc-popup":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AlcPopup);
            }
            break;
    } });
}

export { AlcPopup as A, defineCustomElement as d };
//# sourceMappingURL=alc-popup2.js.map
