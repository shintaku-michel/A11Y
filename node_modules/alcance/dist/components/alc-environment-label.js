...
const AlcEnvironmentLabel$1 = /*@__PURE__*/ proxyCustomElement(class AlcEnvironmentLabel extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.environments = {
    ...
    render() {
        var _a;
        return (h(Host, { key: '978bf8a1bdb0658e3362d2dbcede1486c73ca434', class: {
    ...
    static get style() { return alcEnvironmentLabelCss; }
}, [0, "alc-environment-label", {
        "env": [513]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["alc-environment-label"];
    components.forEach(tagName => { switch (tagName) {
        case "alc-environment-label":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AlcEnvironmentLabel$1);
            }
            break;
    } });
}

const AlcEnvironmentLabel = AlcEnvironmentLabel$1;
const defineCustomElement = defineCustomElement$1;

export { AlcEnvironmentLabel, defineCustomElement };
//# sourceMappingURL=alc-environment-label.js.map
