...
const AlcTooltip$1 = /*@__PURE__*/ proxyCustomElement(class AlcTooltip extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    */
    ...
    static get style() { return alcTooltipCss; }
        ...
        "show": [64],
        "hide": [64]
    }, [[0, "keydown", "handleKeyDown"], [2, "focus", "handleFocus"], [2, "blur", "handleBlur"], [1, "mouseover", "handleMouseOver"], [1, "mouseout", "handleMouseOut"], [0, "click", "handleClick"]], {
        "active": ["watchActive"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["alc-tooltip", "alc-popup"];
    components.forEach(tagName => { switch (tagName) {
        case "alc-tooltip":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AlcTooltip$1);
            }
            break;
        case "alc-popup":
            if (!customElements.get(tagName)) {
...
const AlcTooltip = AlcTooltip$1;
const defineCustomElement = defineCustomElement$1;

export { AlcTooltip, defineCustomElement };
