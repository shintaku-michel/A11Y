...
const AlcField = /*@__PURE__*/ proxyCustomElement(class AlcField extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return alcFieldCss; }
}, [4, "alc-field", {
        "label": [513],
        "hint": [513],
        "required": [516],
...
function defineCustomElement() {
    ...
    const components = ["alc-field"];
    components.forEach(tagName => { switch (tagName) {
        case "alc-field":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AlcField);
            }
            break;
    } });
}

export { AlcField as A, defineCustomElement as d };
//# sourceMappingURL=alc-field2.js.map
