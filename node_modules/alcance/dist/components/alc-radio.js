...
const AlcRadio$1 = /*@__PURE__*/ proxyCustomElement(class AlcRadio extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    render() {
        return (h(Host, { key: '7de3e69e23473c75f75b298af398d03a05f75229' }, h("slot", { key: '94934d27a296bdee39ef63645250f61bce5f7824' }), h("div", { key: '2965ce9a65f9a1912604b47010585142c82dd45f', class: "alc-radio__label" }, h("div", { key: '8a088e0c25d1defce1c2bb95fbffdebb3a8bac01' }, this.label
            ?
                h("label", Object.assign({ htmlFor: this.inputId }, testAttributes('data-test-label')), this.label)
            :
                h("slot", { name: "label" })), this.errorMsg
            ?
                h("small", Object.assign({ class: "alc-radio__text alc-radio__text--error", id: this.errorId }, testAttributes('data-test-error')), this.errorMsg)
            :
                null, this.hint
            ?
                h("small", Object.assign({ class: "alc-radio__text", id: this.hintId }, testAttributes('data-test-hint')), this.hint)
            :
                null)));
    }
    get el() { return this; }
    static get style() { return alcRadioCss; }
}, [4, "alc-radio", {
        "hint": [513],
        "label": [513],
...
function defineCustomElement$1() {
    ...
    const components = ["alc-radio"];
    components.forEach(tagName => { switch (tagName) {
        case "alc-radio":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AlcRadio$1);
            }
            break;
    } });
}

const AlcRadio = AlcRadio$1;
const defineCustomElement = defineCustomElement$1;

export { AlcRadio, defineCustomElement };
