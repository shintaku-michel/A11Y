...
const AlcViewMore$1 = /*@__PURE__*/ proxyCustomElement(class AlcViewMore extends HTMLElement {
    ...
    get el() { return this; }
    static get style() { return alcViewMoreCss; }
}, [4, "alc-view-more", {
        "toggleTextOpen": [513, "toggle-text-open"],
        "toggleTextClose": [513, "toggle-text-close"],
        "togglePosition": [513, "toggle-position"],
        "textClass": [513, "text-class"],
        "minHeight": [513, "min-height"],
        "bgColorVar": [513, "bg-color-var"],
        "contentExpanded": [32]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["alc-view-more"];
    components.forEach(tagName => { switch (tagName) {
        case "alc-view-more":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AlcViewMore$1);
            }
            break;
    } });
}

const AlcViewMore = AlcViewMore$1;
const defineCustomElement = defineCustomElement$1;

export { AlcViewMore, defineCustomElement };
