...
const AlcIcon = /*@__PURE__*/ proxyCustomElement(class AlcIcon extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.iconName = null;
    ...
    static get style() { return alcIconCss; }
}, [0, "alc-icon", {
        "label": [513],
...
function defineCustomElement() {
    ...
    const components = ["alc-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "alc-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AlcIcon);
            }
            break;
    } });
}

export { AlcIcon as A, defineCustomElement as d };
//# sourceMappingURL=alc-icon2.js.map
