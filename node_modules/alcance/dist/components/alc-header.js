...
import { d as defineCustomElement$4 } from './alc-drawer2.js';
import { d as defineCustomElement$3 } from './alc-header-id2.js';
...
const AlcHeader$1 = /*@__PURE__*/ proxyCustomElement(class AlcHeader extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    get el() { return this; }
    static get style() { return alcHeaderCss; }
}, [4, "alc-header", {
        "name": [513],
        "description": [513],
        "homeUrl": [513, "home-url"],
        "isDrawer": [32],
        "isSupportDropdown": [32],
        "needSeparator": [32],
        "isMenuCreated": [32]
    }, [[9, "scroll", "handleScroll"], [8, "alc-nav-content", "handleNavContent"], [9, "resize", "handleResize"]]]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["alc-header", "alc-drawer", "alc-header-id", "alc-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "alc-header":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AlcHeader$1);
            }
            break;
        case "alc-drawer":
            if (!customElements.get(tagName)) {
...
const AlcHeader = AlcHeader$1;
const defineCustomElement = defineCustomElement$1;

export { AlcHeader, defineCustomElement };
