...
import { h as handleKeyDown, g as getFocusableElements } from './keydown.js';
...
const AlcNavPanel$1 = /*@__PURE__*/ proxyCustomElement(class AlcNavPanel extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return alcNavPanelCss; }
}, [4, "alc-nav-panel", {
        "open": [1540],
        "show": [64],
        "hide": [64]
    }, [[9, "resize", "handleResize"], [16, "click", "handleClick"], [0, "keydown", "handleKeyDown"]], {
        "open": ["handleOpen"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["alc-nav-panel", "alc-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "alc-nav-panel":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AlcNavPanel$1);
            }
            break;
        case "alc-icon":
            if (!customElements.get(tagName)) {
...
const AlcNavPanel = AlcNavPanel$1;
const defineCustomElement = defineCustomElement$1;

export { AlcNavPanel, defineCustomElement };
