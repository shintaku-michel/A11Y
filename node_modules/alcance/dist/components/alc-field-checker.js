...
import { d as defineCustomElement$3 } from './alc-alert2.js';
import { d as defineCustomElement$2 } from './alc-icon2.js';

const alcFieldCheckerCss = ".alc-field-checker{display:block}";

const AlcFieldChecker$1 = /*@__PURE__*/ proxyCustomElement(class AlcFieldChecker extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.idAlert = null;
    ...
    static get style() { return alcFieldCheckerCss; }
}, [4, "alc-field-checker", {
        "checkOnSubmit": [516, "check-on-submit"],
        "errorFields": [32]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["alc-field-checker", "alc-alert", "alc-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "alc-field-checker":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AlcFieldChecker$1);
            }
            break;
        case "alc-alert":
            if (!customElements.get(tagName)) {
...
const AlcFieldChecker = AlcFieldChecker$1;
const defineCustomElement = defineCustomElement$1;

export { AlcFieldChecker, defineCustomElement };
