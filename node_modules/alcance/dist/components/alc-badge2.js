...
const AlcBadge = /*@__PURE__*/ proxyCustomElement(class AlcBadge extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        /**
    ...
    static get style() { return alcBadgeCss; }
}, [4, "alc-badge", {
        "label": [1],
        "count": [4],
        "color": [1],
...
function defineCustomElement() {
    ...
    const components = ["alc-badge"];
    components.forEach(tagName => { switch (tagName) {
        case "alc-badge":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AlcBadge);
            }
            break;
    } });
}

export { AlcBadge as A, defineCustomElement as d };
//# sourceMappingURL=alc-badge2.js.map
