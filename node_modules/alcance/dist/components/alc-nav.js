...
const AlcNav$1 = /*@__PURE__*/ proxyCustomElement(class AlcNav extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    }
    ...
    get el() { return this; }
    static get style() { return alcNavCss; }
}, [4, "alc-nav", {
        "togglePanel": [64],
        "setSelectedItem": [64]
    }, [[9, "resize", "handleWindowResize"], [0, "keydown", "handleKeyDown"]]]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["alc-nav", "alc-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "alc-nav":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AlcNav$1);
            }
            break;
        case "alc-icon":
            if (!customElements.get(tagName)) {
...
const AlcNav = AlcNav$1;
const defineCustomElement = defineCustomElement$1;

export { AlcNav, defineCustomElement };
