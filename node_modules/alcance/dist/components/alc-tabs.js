...
import { d as defineCustomElement$3 } from './alc-scroll-panel2.js';
import { d as defineCustomElement$2 } from './alc-tab-button2.js';
...
const AlcTabs$1 = /*@__PURE__*/ proxyCustomElement(class AlcTabs extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return {
        ...
        "hasScroll": [32],
        "select": [64]
    }, [[0, "alc-click", "selectedHandler"], [0, "alc-next", "selectedNextButton"], [0, "alc-previous", "selectedPreviousButton"], [0, "alc-first", "selectedFirstButton"], [0, "alc-last", "selectedLastButton"], [8, "themeLoaded", "themeLoadedHandler"]], {
        "selected": ["selectedChange"]
    }]);
...
function defineCustomElement$1() {
    ...
    const components = ["alc-tabs", "alc-icon", "alc-scroll-panel", "alc-tab-button"];
    components.forEach(tagName => { switch (tagName) {
        case "alc-tabs":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AlcTabs$1);
            }
            break;
        case "alc-icon":
            if (!customElements.get(tagName)) {
...
const AlcTabs = AlcTabs$1;
const defineCustomElement = defineCustomElement$1;

export { AlcTabs, defineCustomElement };
