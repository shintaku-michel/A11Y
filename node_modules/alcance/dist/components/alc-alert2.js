...
const Alert = /*@__PURE__*/ proxyCustomElement(class Alert extends HTMLElement {
    ...
    renderDismissButton() {
        ...
        return (h("div", Object.assign({ class: "alc-alert__dismiss" }, testAttributes('data-test-dismiss')), h("button", { class: `alc-button alc-button-rounded alc-button-rounded--${this.core.type}`, onClick: () => this.hide() }, h("alc-icon", { name: "x-lg", label: "Dispensar" }))));
    }
    componentDidRender() {
...
function defineCustomElement() {
    ...
    const components = ["alc-alert", "alc-icon"];
...
//# sourceMappingURL=alc-alert2.js.map
