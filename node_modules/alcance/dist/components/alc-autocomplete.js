...
function defineCustomElement$1() {
    ...
    const components = ["alc-autocomplete", "alc-field", "alc-icon", "alc-popup"];
    components.forEach(tagName => { switch (tagName) {
        case "alc-autocomplete":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AlcAutocomplete$1);
            }
            break;
        case "alc-field":
            if (!customElements.get(tagName)) {
...
const AlcAutocomplete = AlcAutocomplete$1;
const defineCustomElement = defineCustomElement$1;

export { AlcAutocomplete, defineCustomElement };
